...
class TestTask5(unittest.TestCase):
    ...
    def test___conduct_combat(self):
        ...
        t1._PokeTeam__assign_team("", 1, 2, 1)
        t2._PokeTeam__assign_team("", 1, 1, 1)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, battle_mode) == 1, "Set Mode 3,2,0 vs 1,1,1 failed")
        except AssertionError as e:
        ...
        t2._PokeTeam__assign_team("", 1, 1, 1)
        try:
            self.assertFalse(battle._Battle__conduct_combat(t1, t2, battle_mode) == 2, "Set Mode 3,2,0 vs 1,1,1 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
        
        t1._PokeTeam__assign_team("", 1, 0, 0)
        t2._PokeTeam__assign_team("", 1, 0, 0)
        try:
            self.assertTrue(battle._Battle__conduct_combat(t1, t2, battle_mode) == 1, "Set Mode 3,2,0 vs 1,1,1 failed")
        except AssertionError as e:
            self.verificationErrors.append(str(e))
